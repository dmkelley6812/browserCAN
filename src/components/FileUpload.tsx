...
interface Props {
  ...
  onConnectLive: (baudRate: BaudRate) => void;
}
      ...
      <div className="w-full max-w-lg flex flex-col gap-4">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs">
                {serialSupported
                  ? "USBtin, Canable, PEAK, or any SLCAN adapter"
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => onConnectLive(selectedBaud)}
              disabled={!serialSupported}
              className="ml-auto flex items-center gap-2 px-4 py-1.5 rounded-lg bg-emerald-700 hover:bg-emerald-600 disabled:bg-slate-800 disabled:text-slate-600 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
            >
              Connect
            </button>
          </div>
